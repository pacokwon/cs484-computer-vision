...
distance_pairs = pdist2(test_image_feats, train_image_feats, 'euclidean');
[~, minIdx] = min(distance_pairs);
predicted_categories(:, 1) = train_labels(minIdx(1, :));

% for i=1:M
%     predicted_categories(i, 1) = train_labels(minIdx(1, i));
% end
