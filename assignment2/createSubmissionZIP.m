...
% Compile the PDF if it doesn't exist
writeupFile = ['questions' filesep '2020_Fall_Homework2_Questions.pdf'];
if ~exist(writeupFile,'file')
    cd 'questions'
    command1 = 'pdflatex 2020_Fall_Homework2_Questions.tex';
    command2 = 'bibtex';
    % LaTeX assured compile sequence if bibtex is used
    system( command1 );
    system( command2 );
...
zip( 'cs484submission.zip', {'code/*.m','writeup/writeup.pdf', 'questions/2020_Fall_Homework2_Questions.pdf'} );
